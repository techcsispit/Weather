...
function Templayout(props) {
  ...
  const feelsLike = Math.round(props.feels - 273);
  ...
  function setIconN() {
    switch (weather) {
      case "Thunderstorm":
        return <img src="https://openweathermap.org/img/wn/11n@2x.png"></img>;
      case "Drizle":
        return <img src="https://openweathermap.org/img/wn/09n@2x.png"></img>;
      case "Rain": {
        switch (weatherdesc) {
          case "freezing rain":
            return (
              <img src="https://openweathermap.org/img/wn/13n@2x.png"></img>
            );
          case "light intensity shower rain":
            return (
              <img src="https://openweathermap.org/img/wn/09n@2x.png"></img>
            );
          case "shower rain":
            return (
              <img src="https://openweathermap.org/img/wn/09n@2x.png"></img>
          ...
          default:
            return (
              <img src="https://openweathermap.org/img/wn/10n@2x.png"></img>
            );
        }
      }
      case "Mist":
        return <img src="https://openweathermap.org/img/wn/50n@2x.png"></img>;
      case "Smoke":
        return <img src="https://openweathermap.org/img/wn/50n@2x.png"></img>;
      case "Haze":
        return <img src="https://openweathermap.org/img/wn/50n@2x.png"></img>;
      ...
      case "Squall":
        return <img src="https://openweathermap.org/img/wn/50n@2x.png"></img>;
      case "Tornado":
        return <img src="https://openweathermap.org/img/wn/50d@2x.png"></img>;
      case "Clear":
        return <img src="https://openweathermap.org/img/wn/01d@2x.png"></img>;
      case "Clouds": {
        switch (weatherdesc) {
          case "few clouds":
            return (
              <img src="https://openweathermap.org/img/wn/02n@2x.png"></img>
            );
          case "scattered clouds":
            return (
              <img src="https://openweathermap.org/img/wn/03n@2x.png"></img>
            );
          default:
            return (
              <img src="https://openweathermap.org/img/wn/04n@2x.png"></img>
            );
        }
      }
    }
  ...
  function setIconD() {
    ...
    switch (weather) {
      case "Thunderstorm":
        return <img src="https://openweathermap.org/img/wn/11d@2x.png"></img>;
      case "Drizle":
        return <img src="https://openweathermap.org/img/wn/09d@2x.png"></img>;
      case "Rain": {
        switch (weatherdesc) {
          case "freezing rain":
            return (
    ...
    <div>
      <div className="outer-data">
        <div className="icon-desc">
          <div className="data-icon">{setIcon()}</div>
        ...
        <div className="data">
          ...
          <div className="data-temp">
            <div className="temp">{temperature}°C</div>
              <div className="feels" style={{fontSize:20}}>Feels Like : {feelsLike}°C</div>

            <div className="data-other">
              <div className="data-location">
                {city}, {country}
              </div>
              <div className="data-minmax">{minmax()}</div>
            </div>
          </div>
      ...
      <div className="date-time">
        <div className="date">
          {" "}
          {weekday}, {dateofmonth} {monthtext} {year}{" "}
        </div>
        <div className="time">
          {hours}:{setMinutes()} {ampm}
        </div>
      </div>
    </div>
  );
